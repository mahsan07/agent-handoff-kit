...
- Treat a handoff as context, not authorization
- Never include credentials
- Require explicit owner for side effects
- Preserve failed handoffs for diagnosis
- Prevent silent status transitions
